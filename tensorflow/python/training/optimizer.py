...
class Optimizer(
  ...
  def minimize(self, loss, global_step=None,
    ...
    @end_compatibility
    """
    grads_and_vars,shift_list, bitnum_list, update_step_list, m_list = self.compute_gradients(
    ...
    return self.apply_gradients(grads_and_vars, global_step=global_step,
                                shift_list=shift_list, bitnum_list=bitnum_list,
                                update_step_list=update_step_list, m_list=m_list,
                                name=name)

  def compute_gradients(self, loss, var_list=None,
                        global_step=None,#liuchang
                        mode=0,
                        interval=None,
                        steps_per_epoch=None,
    ...
    grads, shift_list, bitnum_list, update_step_list, m_list = gradients.gradients(
        loss, var_refs,
        global_step=global_step,#liuchang
        mode=mode,
        interval=interval,
        steps_per_epoch=steps_per_epoch, 
        grad_ys=grad_loss,
    ...
    return grads_and_vars, shift_list, bitnum_list, update_step_list, m_list #liuchang

  def apply_gradients(self, grads_and_vars, global_step=None,
                      shift_list=None, bitnum_list=None, update_step_list=None, m_list=None, #liuchang
                      name=None):
    ...
    with ops.name_scope(name, self._name) as name:
      ...
      if update_step_list is not None:
        return apply_updates, shift_list, bitnum_list, update_step_list, m_list
      elif bitnum_list is not None:
        return apply_updates, shift_list, bitnum_list
      elif shift_list is not None:
        return apply_updates, shift_list
      else:
